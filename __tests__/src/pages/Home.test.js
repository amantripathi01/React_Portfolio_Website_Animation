...
describe('Home Component', () => {
  ...
  test('renders without crashing', () => {
    ...
    expect(screen.getByText('FullStack Developer and Youtube Teacher based in Poland')).toBeInTheDocument();
  });
  ...
  test('contains animated elements', () => {
    ...
    const descElement = screen.getByText('FullStack Developer and Youtube Teacher based in Poland');
